$(document).ready(function () {
  ...
  // define pageContents
  const homeContent = `<main class="wrapper page_style bg-gradient-to-br from-indigo-900 via-blue-800 to-blue-600 h-screen w-screen">
    <div class="introduction page_description grid grid-rows-6 grid-flow-col justify-center text-center gap-10 text-white">
  ...
  const projectContent = `<div class="page_description grid grid-rows-2 grid-cols-9 justify-center text-center gap-10 text-white">
  ...
  const skillsContent = `<div class="page_description grid grid-rows-2 grid-cols-9 justify-center text-center gap-10 text-white">
        <div class="row-span-1 col-span-9"></div>
        ${nav}
        ${resumeDownload}
        <div class="col-span-1"></div>
  ...
  const aboutContent = `<div class="overlay bg-local"></div>
  <div class="page_description grid grid-rows-2 grid-cols-9 justify-center text-center gap-10 text-white">
  <div class="row-span-1 col-span-9"></div>
  ${nav}
  <div class="aboutHeader col-span-7 justify-center w-64">
    <h2 class="text-2xl font-bold text-gray-100 pt-4 text-5xl">Who is Robert Schmahl?</h2>
    <h3 class="text-xl font-semibold text-blue-900 pt-1 pb-4 text-xl pb-4">Or, How I Learned to Stop Worrying and Love the Process</h2>
  </div>
  <div class="aboutContent1 bg-gray-300 col-span-7 rounded-lg shadow-lg text-blue-900 p-4">
  ...
  <div class="aboutContent2 col-span-9 justify-center text-2xl font-extrabold text-blue-900 p-4">
    <p class="${pStyles}">Spoiler Alert: I am no longer working in politics</p>
  </div>
  <div class="aboutContent3 bg-gray-100 col-span-7 rounded-lg shadow-lg text-blue-900 p-4">
  ...
  <div class="aboutContent4 col-span-9 justify-center text-5xl font-extrabold text-blue-900 p-4">
    <p class="${pStyles}">Then, COVID-19</p>
  </div>
  <div class="aboutContent5 bg-gray-100 col-span-7 rounded-lg shadow-lg text-blue-900 p-4">
  ...
  <div class="aboutContent6 col-span-9 justify-center text-3xl font-extrabold text-blue-900 p-4">
    <p class="${pStyles}">I really feel like this work is for me</p>
  </div>
  <div class="col-span-1"></div>`;

  const contactContent = `<div class="page_description grid grid-rows-2 grid-cols-9 justify-center text-center gap-10 text-white">
  <div class="row-span-1 col-span-9"></div>
  ${nav}
  ...
  function pageRender(addClasses, pageContent) {
    // animate content
    ...
    setTimeout(function () {
      // empty DOM and add background gradient
      $("#page_style").empty().attr("class", `animate_content fadeIn ${addClasses}`);
    }, 1600);

    setTimeout(function () {
      // empty all of the body after page_style div and render new pageContent
      $("#page_style").append(pageContent)
  ...
  $(document).on("click", ".btn_nav", function () {
    ...
    if (btnTxt == "Projects") {
      let addClasses =
        "wrapper page_style bg-gradient-to-br from-green-900 via-green-600 to-teal-600 h-screen";
      pageRender(addClasses, projectContent);
    ...
    if (btnTxt == "Skills") {
      let addClasses =
        "wrapper page_style bg-gradient-to-br from-orange-700 via-orange-500 to-yellow-400 h-screen";
      pageRender(addClasses, skillsContent);
      ...
      setTimeout(function () {
        ...
        $(".resumeLink")
          ...
          .removeClass(`col-span-9 h-screen bg-gray-100`);
    ...
    if (btnTxt == "Home") {
      let addClasses =
        "wrapper page_style bg-gradient-to-br from-indigo-900 via-blue-800 to-blue-600";
      pageRender(addClasses, homeContent);
    ...
    if (btnTxt == "About") {
      let addClasses =
        "wrapper page_style bg-fixed bg-gradient-to-br from-blue-900 via-teal-400 to-teal-200";
      pageRender(addClasses, aboutContent);
    ...
    if (btnTxt == "Contact") {
      let addClasses =
        "wrapper page_style bg-gradient-to-br from-purple-800 via-indigo-700 to-indigo-400";
      pageRender(addClasses, contactContent);
